        ...
        text: 'Cars', icon: 'imgs/car.png', route: null, subMenu: [
            {
                text: 'Select', icon: 'imgs/car.png', route: null, subMenu: [
                    { text: 'Audi', icon: 'imgs/car.png', route: '/authenticated/car-detail/audi', subMenu: null },
                    { text: 'BMW', icon: 'imgs/car.png', route: '/authenticated/car-detail/bmw', subMenu: null },
                    { text: 'Fiat', icon: 'imgs/car.png', route: '/authenticated/car-detail/fiat', subMenu: null },
                    { text: 'Ford', icon: 'imgs/car.png', route: '/authenticated/car-detail/ford', subMenu: null }
                ]
            },
